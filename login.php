...
$query=mysqli_query($con,"select * from user natural join branch where username='$user' and password='$pass' and branch_id='$branch' and status='active'")or die(mysqli_error($con));
   ...
   //if($user_group==='2'){
 	    echo "<script type='text/javascript'>document.location='dash_board.php'</script>";
 //	}
...
// 		 echo "<script type='text/javascript'>document.location='inward_transaction.php'</script>";
// 	}
	  }
}	 
