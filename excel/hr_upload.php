...
//$studentQuery = "INSERT INTO `locations`(`stock_location`, `conditions`, `type`, `exiting`, `unit`) VALUES ('$a','Ambient','Racked','Yes','3')";

$studentQuery = "INSERT INTO `hrtbl`(`dat`, `unit`, `hrs`) VALUES ('$a','$b','$c')";
...
echo "<script>document.location='http://sovereign-wh.com/AdminLTE/pages/tables/index_tp.php'</script>"; 
?>