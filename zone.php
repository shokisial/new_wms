...
<div class="layout">
  ...
  <aside class="sidebar">
    ...
    <a href="zone.php" class="nav-item" style="color:var(--orange-lt)">
      <svg viewBox="0 0 14 14" fill="none" style="opacity:1"><rect x="1" y="1" width="12" height="12" rx="2" stroke="currentColor" stroke-width="1.2"/><path d="M1 5h12M5 5v7" stroke="currentColor" stroke-width="1.2" stroke-linecap="round"/></svg>
      Zones
    </a>
    <div class="nav-sep"></div>
