...
<div class="layout">
  ...
  <aside class="sidebar">
    ...
    <a href="dealer.php" class="nav-item" style="color:var(--orange-lt)">
      <svg viewBox="0 0 14 14" fill="none" style="opacity:1"><rect x="1" y="3" width="12" height="10" rx="1.5" stroke="currentColor" stroke-width="1.2"/><path d="M1 6h12M5 3V1M9 3V1" stroke="currentColor" stroke-width="1.2" stroke-linecap="round"/></svg>
      Stock Adjustment
    </a>
    <div class="nav-grp">
      <div class="nav-grp-hdr">
