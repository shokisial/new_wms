...
<div class="layout">
  ...
  <aside class="sidebar">
    ...
    <a href="supplier.php" class="nav-item" style="color:var(--orange-lt)">
      <svg viewBox="0 0 14 14" fill="none" style="opacity:1"><circle cx="7" cy="4.5" r="2.5" stroke="currentColor" stroke-width="1.2"/><path d="M2 12c0-2.761 2.239-5 5-5s5 2.239 5 5" stroke="currentColor" stroke-width="1.2" stroke-linecap="round"/></svg>
      Customers
    </a>
    <div class="nav-sep"></div>
